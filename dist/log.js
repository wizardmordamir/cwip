...
let loggerUpdater;
const getFileFromStack = (stack, index) => { var _a; return ((_a = stack[index]) === null || _a === void 0 ? void 0 : _a.getFileName()) || ''; };
exports.getFileFromStack = getFileFromStack;
const getLineFromStack = (stack, index) => { var _a; return ((_a = stack[index]) === null || _a === void 0 ? void 0 : _a.getLineNumber()) || ''; };
