import { missingVals, removeArrayValues, removePrimitiveDups, valsExistInArray } from './arrays';

describe('arrays', () => {
  describe('missingVals', () => {
    it('finds missingVals', () => {
      const arr = [1, 2, 3];
      const vals = [1, 3, 4];
      expect(missingVals(arr, vals)).toEqual([4]);
    });
  });
